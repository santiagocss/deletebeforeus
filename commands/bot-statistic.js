  ...
  run: async (client, interaction) => {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(`ListenUp is a free discord music bot wich aims to provide free 24/7 music for everyone!\n`)
        .setColor(5088656)
        .setImage(msg.author.avatarURL())
        .addFields(
          { name: 'Server Count', value: `${client.guilds.cache.size}`, inline: true },
          { name: 'User Count', value: `${client.guilds.cache.reduce((a, b) => a + b.memberCount, 0)}`, inline: true },
          { name: 'Ping', value: `${client.ws.ping} MS`, inline: true },
        )
        .setFooter({ text: 'Free for everyone!' })
        .setTimestamp()
